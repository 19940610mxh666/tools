 ...
 * 
 * @author mxh
 * @version 创建时间：2018年8月7日上午1:22:16 类说明
 */
public class Global {
	...
	public static EmailBean getEmail() {
		...
		mb.setHost(getConfig("sender.host")); // 设置SMTP主机(163)，若用126，则设为：smtp.126.com
		mb.setUsername(getConfig("sender.userNAme")); // 设置发件人邮箱的用户名
		mb.setPassword(getConfig("sender.password")); // 设置发件人邮箱的密码，需将*号改成正确的密码
		mb.setFrom(getConfig("sender.userNAme")); // 设置发件人的邮箱
		mb.setSubject("舱单"); // 设置邮件的主题
		mb.setContent("舱单"); // 设置邮件的正文
		return mb;
	}
}
